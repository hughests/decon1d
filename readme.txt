I have changed several things about the program, including now condensing both the settings and compuational script into one file. For details about this software see Deconvolution of Complex 1D NMR Spectra Using Objective Model Selection
